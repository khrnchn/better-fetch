...
By default the response data will always be type of `unknown`. If you want to customize the default type you can pass `defaultOutput` option to the `createFetch` function.
...
if you want custom default error type, you can pass a `default error` option to the `createFetch` function. 
